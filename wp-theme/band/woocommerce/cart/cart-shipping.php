...
<tr class="woocommerce-shipping-totals shipping">
	<td colspan="3">
		<h3 class="heading text-center">Способ доставки</h3>
			...
			<ul id="shipping_method" class="woocommerce-shipping-methods">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						printf( ' <label for="shipping_method_%1$s_%2$s">%3$s</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label_dub( $method ) ); // WPCS: XSS ok.
